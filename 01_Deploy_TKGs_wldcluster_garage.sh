...
# Go to the directory 
cd /Users/kfrederic/Documents/GitHub/TKG

# Login to management
kubectl vsphere login --server 10.16.3.3 --vsphere-username administrator@cpod-tanzu.az-fkd.cloud-garage.net --insecure-skip-tls-verify
kubectl config use-context development

# Deploy a cluster in the development vsphere namespace
# https://docs.vmware.com/fr/VMware-vSphere/7.0/vmware-vsphere-with-tanzu/GUID-4E68C7F2-C948-489A-A909-C7A1F3DC545F.html
k apply -f /Users/kfrederic/Documents/GitHub/TKG/cpod/workload-development-cluster01.yaml

# Deploy a cluster in the production vsphere namespace
# https://docs.vmware.com/fr/VMware-vSphere/7.0/vmware-vsphere-with-tanzu/GUID-4E68C7F2-C948-489A-A909-C7A1F3DC545F.html
k apply -f /Users/kfrederic/Documents/GitHub/TKG/cpod/workload-production-cluster01.yaml
...
kubectl describe tanzukubernetescluster tkgs-dev01
...
kubectl vsphere login --server  10.16.3.3 \
--vsphere-username administrator@cpod-tanzu.az-fkd.cloud-garage.net  \
